        ...
        <Alert show-icon>基本信息</Alert>
            <div style="margin-top:10px;margin-bottom:10px">
                <Row>
                    ...
                    <Col span="9"><p> {{formData.db_code}} </p></Col>
                </Row>

                <Row>
                    <Col span="3"><p> <b>主机：</b> </p></Col>
                    <Col span="9"><p> <Tag color="blue">{{formData.db_host}}</Tag> </p></Col>
                    <Col span="3"><p> <b>端口</b>  </p></Col>
                    <Col span="9"><p> <Tag color="blue">{{formData.db_port}}</Tag></p></Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col span="9"><p> {{formData.db_pwd}} </p></Col>
                </Row>

                <Row>
                    <Col span="3"><p> <b>类型</b> </p></Col>
                    <Col span="9"><p> <Tag color="blue">{{formData.db_type}}</Tag> </p></Col>
                ...
                <Row>
                    ...
                    <Col span="9"><p> {{formData.db_env}}</p></Col>
                    <Col span="3"><p> <b>角色</b>  </p></Col>
                    <Col span="9"> <Tag color="blue"> {{formData.db_mark}}</Tag> </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col span="9"> <Tag color="blue"> {{formData.proxy_host}}</Tag> </Col>
                </Row>


                <Row>
                    <Col span="3"><p> <b>备注</b>  </p></Col>
                    <Col span="9"><p> {{formData.db_detail}} </p></Col>
                </Row>
